...
const clientId = "BMtQQVT2zPK_EQ__o8FjtawPD209RZa4fsCw-08pEFG_Tgko5OOPgYUH4-e7fXDrbkKa9ohmYrNEufbnrzbB0XM";
        ...
        <div className="flex items-center">
          ...
          <Link href="/" className="flex items-center">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-base md:text-lg text-gray-800">WasteController</span>
              <span className="text-[8px] md:text-[10px] text-gray-500 -mt-1">Complete waste control</span>
            </div>
          </Link>
        </div>
        {!isMobile && (
